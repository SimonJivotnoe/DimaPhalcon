...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 06 2015 г., 01:11
...
(114, 'Утка', 12, '[{"%ROW_NUMBER%":"A1","%ROW_NAME%":"","%DATA_CELL%":"A1","%DATA_FORMULA%":"","%INPUT_VALUE%":""}]', '[]', '<li class="list-group-item"><span class="formulaValue">A2+A1</span></li><li class="list-group-item"><span class="formulaValue">A3+A2</span></li><li class="list-group-item"><span class="formulaValue">A6+A8</span></li>\n    <li class="list-group-item"><span class="formulaValue">A1*SIN(A2)</span></li>', '2015-06-29 19:54:00'),
(173, 'sdfsdfwe', 11, '{"0":{"%ROW_NUMBER%":"A2","%ROW_NAME%":"rthfh","%DATA_CELL%":"A2","%DATA_FORMULA%":"","%INPUT_VALUE%":"3"},"1":{"%ROW_NUMBER%":"A5","%ROW_NAME%":"bhmkk","%DATA_CELL%":"A5","%DATA_FORMULA%":"","%INPUT_VALUE%":"20"},"2":{"%ROW_NUMBER%":"A4","%ROW_NAME%":"hkhjk","%DATA_CELL%":"A4","%DATA_FORMULA%":"","%INPUT_VALUE%":"200"},"3":{"%ROW_NUMBER%":"A7","%ROW_NAME%":"","%DATA_CELL%":"A7","%DATA_FORMULA%":"","%INPUT_VALUE%":""},"4":{"%ROW_NUMBER%":"A8","%ROW_NAME%":"","%DATA_CELL%":"A8","%DATA_FORMULA%":"","%INPUT_VALUE%":""}}', '{"0":{"%ROW_NUMBER%":"KIM1","%ROW_NAME%":"КИМ","%DATA_CELL%":"KIM1","%DATA_FORMULA%":"","%INPUT_VALUE%":""},"1":{"%ROW_NUMBER%":"S1","%ROW_NAME%":"Площадь, м2","%DATA_CELL%":"S1","%DATA_FORMULA%":"","%INPUT_VALUE%":"-0.01"},"2":{"%ROW_NUMBER%":"PR1","%ROW_NAME%":"Цена за м2, грн","%DATA_CELL%":"PR1","%DATA_FORMULA%":"","%INPUT_VALUE%":""},"3":{"%ROW_NUMBER%":"SUM1","%ROW_NAME%":"Сумма, грн","%DATA_CELL%":"SUM1","%DATA_FORMULA%":"","%INPUT_VALUE%":""}}', NULL, '2015-07-05 21:50:42');
